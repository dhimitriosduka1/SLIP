...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        default="yfcc15m",
        type=str,
        choices=["yfcc15m", "cc3m", "cc12m", "coco", "redcaps"],
    )
    ...
    parser.add_argument(
        "--ssl-scale", default=1.0, type=float, help="loss scale for SimCLR objective"
    )
    parser.add_argument(
        "--ssl-temp",
        default=0.1,
...
def main(args):
    ...
    criterion = models.get_loss(args.model, args.ssl_temp, args.ssl_scale).cuda(
        args.gpu
    )
